...
class DataTransformation:
    def __init__(self,data_validation_artifact:DataValidationArtifact,
                 data_tranformatoion_config:DataTransformationConfig):
        try:
            self.data_validation_artifact:DataValidationArtifact = data_validation_artifact
            self.data_transformation_config:DataTransformationConfig = data_tranformatoion_config
    ...
    def initiate_data_transformation(self) ->DataTransformationArtifact:
        logging.info("Enter initiate_data_transformation method of the Datatransformation class")
        try:
