...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            logging.info("Data Ingeation Completed and Artifact: {data_ingestion_artifact}")
    ...
    def start_data_transformation(self,data_validation_artifact:DataValidationArtifact):
        try:
            ...
            data_transformation = DataTransformation(data_validation_artifact=data_validation_artifact,data_tranformatoion_config=self.data_transformation_config)
    ...
    # My final model is going to s3 bucket
